...
export default function WhatsAppButton({
  ...
  const base =
    variant === "primary"
      ? "group relative overflow-hidden bg-gradient-to-b from-[#12BD6C] via-[#00A859] to-[#008F4C] text-white shadow-[0_4px_22px_-8px_rgba(0,168,89,0.55),inset_0_1px_0_rgba(255,255,255,0.3)] hover:shadow-[0_8px_36px_-8px_rgba(0,168,89,0.85),inset_0_1px_0_rgba(255,255,255,0.4)]"
  ...
  const shine = variant === "primary" && (
    <span
      aria-hidden
      className="pointer-events-none absolute inset-0 -translate-x-[160%] skew-x-12 bg-gradient-to-r from-transparent via-white/30 to-transparent transition-transform duration-700 ease-out group-hover:translate-x-[160%]"
    />
  );
